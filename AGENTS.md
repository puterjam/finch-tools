...
| finch-image-gen | image-gen | 0.2.0 | 对接 OpenAI 图像 API，支持文生图/图生图，API Key 经 permissions.secrets 由 Finch 设置页安全存储；API base URL 可通过 image_gen_configure 工具（弹表单）切换到中转站，存于 ctx.storage |
